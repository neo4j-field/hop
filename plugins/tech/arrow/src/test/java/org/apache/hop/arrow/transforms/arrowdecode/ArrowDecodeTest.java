...
public class ArrowDecodeTest {
  ...
  public void testDecodingSingleBatch() throws HopException {
    ...
    ArrowDecode transform =
        new ArrowDecode(amh.transformMeta, meta, data, 0, amh.pipelineMeta, amh.pipeline);
    transform.init();
  ...
  private IRowSet mockInputRowSet() {
    ...
    IRowSet inputRowSet =
        amh.getMockInputRowSet(new Object[][] {{new FieldVector[] {ageVector, nameVector}}});
